...
public class HouseDaoImpl implements HouseDao{
	...
	private Map<String, int[]> environ;
	private List<CS> cs;
	private int size;
	private List<HouseDeal> search;
	//private List<CS> searchCS;
...
//	}
	...
	@Override
	public List<CS> searchCS(String dong) {
		//searchCS.clear();
		List<CS> finds = new LinkedList<CS>();
		//	System.out.println("hello");
		//boolean[] type = bean.getDong();
		for(CS css : cs) {
//			System.out.println(css);
			if(css.getDong().equals(dong)) {
				System.out.println(dong);
				finds.add(css);
			}
		}
//		for (int i = 0, size=cs.size(); i < size; i++) {
//			if(cs.get(i).getDong().equals(dong)) {
//				System.out.println(dong);
//				finds.add(cs.get(i));
//			}
//		}
