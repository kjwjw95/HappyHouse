...
public class HouseSaxParser {
	...
	private Map<String, int[]> environment;
	private List<CS> cs;
	private int size;
	/**
	...
	private void loadData() {
		...
		try{
			...
			ReadCSVTest environ = new ReadCSVTest();
			environment = environ.ReadCSV();
			cs=environ.ReadCSV2();
	...
	public Map<String, int[]> getEnvironment() {
		return environment;
	}

	public void setEnvironment(Map<String, int[]> environment) {
